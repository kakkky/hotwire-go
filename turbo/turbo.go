...
func TemplateFuncMap() template.FuncMap {
	return template.FuncMap{
		...
		"turboAttrConfirm":                  func(message string) template.HTMLAttr { return AttrConfirm(message).HTMLAttr() },
		"turboAttrSubmitsWith":              func(text string) template.HTMLAttr { return AttrSubmitsWith(text).HTMLAttr() },
		...
		"turboMetaRoot":                     func(path string) template.HTML { return MetaRoot(path).HTMLTag() },
		...
		"turboFrame":                        func(id string) template.HTML { return Frame(id).HTMLTag() },
		"turboFrameEnd":                     func() template.HTML { return Frame("").Close().HTMLTag() },
		"turboAttrSrc":                      func(url string) template.HTMLAttr { return AttrSrc(url).HTMLAttr() },
